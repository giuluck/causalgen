...
binary_operations: Dict[str, Tuple[np.ndarray, np.ndarray]] = {
    ...
    'true_divide': (rng.uniform(-100, 100, size=size), rng.uniform(-100, 100, size=size)),
    'floor_divide': (rng.integers(-100, 100, size=size), rng.integers(-100, 100, size=size)),
    'power': (rng.uniform(0, 100, size=size), rng.uniform(0, 100, size=size)),
    'mod': (rng.integers(-100, 100, size=size), rng.integers(-100, 100, size=size)),
